...
├── src/                # Código fuente del asistente IA

│   ├── pipeline/       # Pipeline de ingesta y procesamiento de documentos

│   ├── rag/            # Módulo de arquitectura RAG

│   └── api/            # Backend Flask

├── data/               # Datasets y documentación técnica procesada
...
Integrantes   @Ccmarta22  @matiasespindola88  @nadpess  @fedesolis8 
